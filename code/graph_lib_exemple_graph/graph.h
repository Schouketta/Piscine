...
/**************************************************************
    ...
    Sommet et Arete se déclarent amis (friend) de Graph pour que
    ...
    et que les parcours à itérateur ne donneront pas directement des Arete ou des Sommet
...
class GraphInterface
{
    ...
    private :
        ...
        grman::WidgetBox m_bouton_delete;
        grman::WidgetBox m_bouton_add;
        grman::WidgetBox m_bouton_save;
        grman::WidgetBox m_bouton_return;

        grman::WidgetText m_delete;
        grman::WidgetText m_add;
        grman::WidgetText m_save;
        grman::WidgetText m_return;
...
class Graph
{
    private :
        ...
        std::vector<std::string> m_vecNomSommets;
        std::vector<std::string> m_vecNomImages;
        //std::vector<Arete> m_vec
    ...
    public:
        ...
        void add_interfaced_Sommet(int idx, std::string nomSommet, double value, int x, int y, std::string pic_name="", int pic_idx=0 );
        ...
        void chargerGraphe(std::string nomFichier);
        ...
        void afficherListeImages();
        void afficherPoidsAretes();
        void forteConnexite();

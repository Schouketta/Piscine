...
void menu_afficher (BITMAP* fond,BITMAP* page)

{
    ...
    rectfill(screen,28,625,322,723, makecol(121,121,248));
    textprintf_centre_ex(screen, font, 175, 674, makecol(0,0,0), -1, "Chaine 1");

    rectfill(screen,368,625,660,723, makecol(225,206,154));
    textprintf_centre_ex(screen, font, 514, 674, makecol(0,0,0), -1, "Chaine 2");

    rectfill(screen,368,518,660,596, makecol(127,206,114));
    textprintf_centre_ex(screen, font, 514, 557, makecol(0,0,0), -1, "Sortie");

    rectfill(screen,690,625,982,723, makecol(150,225,174));
    textprintf_centre_ex(screen, font, 836, 674, makecol(0,0,0), -1, "Chaine 3");
